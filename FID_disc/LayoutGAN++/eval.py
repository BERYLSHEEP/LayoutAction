...
def main():
    ...
    parser.add_argument('--pkl_paths', type=str, 
                        nargs='+',help='generated pickle path')
    ...
    dataset = get_dataset(args.dataset, 'test', transform=T.Compose(transforms))
    ...
    # fid_test = LayoutFID(args.dataset)
    ...
    for i, data in enumerate(dataloader):
        ...
        # fid_test.collect_features(model, bbox, label, padding_mask,
                                #   real=True)
