...
def get_args():
    ...
    parser.add_argument("--train_dir", default="DeepLayout/data/Rico/train", help="/path/to/train")
    parser.add_argument("--val_dir", default="DeepLayout/data/Rico/val", help="/path/to/val")
    parser.add_argument("--test_dir", default="DeepLayout/data/Rico/test", help="/path/to/test")
    parser.add_argument('--model_path', default=None, type=str, help="pretrained model path")
    parser.add_argument("--pkl_path", type=str, default="", help="for evaluating FID scores")
    parser.add_argument("--model_save_name", type=str, default="checkpoint_D.pth")
